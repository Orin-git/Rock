...
package_name = 'xw_health'

data_files = [
    ('share/ament_index/resource_index/packages', ['resource/xw_health']),
        ('share/xw_health', ['package.xml']),
]
...
setup(
    ...
    description='Topic health file probe',
    license='Apache-2.0',
    tests_require=['pytest'],
    entry_points={
        'console_scripts': [
        'topic_health_node = xw_health.topic_health_node:main',
        ],
    },
)
