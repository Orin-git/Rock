...
void CameraSrv::onAttached(AS_CAM_ATTR_S *attr, void *privateData)
{
    ...
    LOG(INFO) << "this is a new attach device, wait 1s before create ..." << std::endl;
