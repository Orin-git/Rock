...
package_name = 'xw_chassis'

data_files = [
    ('share/ament_index/resource_index/packages', ['resource/xw_chassis']),
        ('share/xw_chassis', ['package.xml']),
]
...
setup(
    ...
    entry_points={
        'console_scripts': [
        'chassis_node = xw_chassis.chassis_node:main',
        ],
    },
)
