    ...
    nodes = [
        ...
        Node(
            ...
            parameters=[{
                ...
                'min_follow_distance': 0.55,
                'enable_search_spin': False,
                'use_width_range': True,
                'stop_width_ratio': 0.52,
                'start_width_ratio': 0.20,
                'turn_first_bearing': 0.18,
                'coast_yaw': True,
                'coast_yaw_scale': 0.55,
                'search_yaw_rate': 0.20,
                'lost_timeout_s': 2.5,
                'coast_hold_s': 1.0,
                'fresh_timeout_s': 2.0,
